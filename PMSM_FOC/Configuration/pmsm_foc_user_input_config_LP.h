...
#ifndef USER_INPUT_CONFIG_LP_H_
#define USER_INPUT_CONFIG_LP_H_
...
#define USER_ROTOR_PRE_ALIGNMENT_V_RAMP_RATE        (30.0F)         /*!< in volt/sec. Voltage is ramped to USER_ROTOR_PRE_ALIGNMENT_VOLTAGE_V and then maintained for USER_ROTOR_PRE_ALIGNMENT_TIME_MS*/
#define USER_ROTOR_PRE_ALIGNMENT_VOLTAGE_V          (1.2F)           /*!< in volts  should be less than PMSM_FOC_SL_DC_LINK_VOLT */
#define USER_ROTOR_PRE_ALIGNMENT_TIME_MS            (200.0F)         /*!< Rotor startup alignment time in mSec. Min range: 1/PWM_Freuency */

#define USER_VQ_INITIAL_VALUE_V                     (1.4F)                          /*!<  Direct FOC Startup - Vq value initial value based upon load and max current */
...
#define  USER_MOTOR_R_PER_PHASE_OHM                 (0.85f)       /*!< Motor Resistance per phase in Ohm for PMSM Motor */
#define  USER_MOTOR_LS_PER_PHASE_uH                 (1414.0f)      /*!< Motor Inductance Ls per phase in uH  */
#define  USER_MOTOR_POLE_PAIR                       (2.0f)        /*!< Motor Pole Pairs */
#define  USER_SPEED_HIGH_LIMIT_RPM                  (3500U)       /*!< No load Speed of User Motor*/
#define  USER_SPEED_LOW_LIMIT_RPM                   (200U)        /*!< Min Speed of User Motor, original 200U*/
#define  NO_LOAD_SPEED_RPM                          (8000.0f)     /* No-load speed for calculation of the BEMF constant */
#define  STALL_TORQUE_NM 	                          (0.05f)       /* Stall torque threshold */
#define  GEAR_RATIO                                 (58.22f)      /* Define the ratio if there is a gearbox. Otherwise define as 1.0f */
#endif
...
#define USER_SPEED_RAMPUP_RPM_PER_S                (2000U)
#define USER_SPEED_RAMPDOWN_RPM_PER_S              (2000U)
...
#define USER_PLL_SPEED_LPF                          (6)                                 /*!<0 - Filter Disabled, >0 - Filter enabled(Time const = PWM_PERIOD * 2^USER_PLL_LPF) */
...
#define USER_PI_SPEED_KP                            (2000)                          /*!<  SPEED PI CTRL - Proportional gain Kp, uint16_t. */
#define USER_PI_SPEED_KI                            (1)                             /*!<  SPEED PI CTRL - Integral gain Ki, uint16_t. */
#define USER_PI_SPEED_SCALE_KPKI                    (13)                            /*!<  SPEED PI CTRL - kp,ki scale, uint16_t. */

#define USER_PI_PLL_KP                              (150)                            /*!<  PLL PI CTRL - Proportional gain Kp, uint16_t. */
#define USER_PI_PLL_KI                              (1)                             /*!<  PLL PI CTRL - Proportional gain Kp, uint16_t. */
#define USER_PI_PLL_SCALE_KPKI                      (10)                             /*!<  PLL PI CTRL - Proportional gain Kp, uint16_t. */
...
static const int32_t speedPoints[NUM_SEGMENTS + 1] = {2249, 4889, 9414, 16957, 32767};
static const int32_t pllKpPoints[NUM_SEGMENTS + 1] = {6000, 1500, 500, 50, 20};
#define SCALE_PLL_KP_ADJUSTMENT 10
#endif
