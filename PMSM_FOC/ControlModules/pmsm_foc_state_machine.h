...
__STATIC_INLINE void PMSM_FOC_MSM_STOP_MOTOR_Func(void)
{
  if (MotorVar.MaskedFault.Value == 0)
  {
    ...
    else
    {
      ...
      /* Configure motor direction based upon configuration */
      PMSM_FOC_CTRL.rotation_dir = PMSM_FOC_CTRL.rotation_dir_target;
...
__STATIC_INLINE void PMSM_FOC_MSM_PRE_POSITIONING_Func(void)
{
	// optimization/Current sensing for monitoring at pre-alignment
  ...
  else
  {
    ...
    PMSM_FOC_OUTPUT.rotor_angle_q31 = PMSM_FOC_ANGLE_270_DEGREE_Q31;
	  PMSM_FOC_OUTPUT.svm_angle_16 = 49152;	// 270/360*65536
	  PMSM_FOC_PLL_ESTIMATOR.rotor_angle_q31 = PMSM_FOC_ANGLE_270_DEGREE_Q31;
