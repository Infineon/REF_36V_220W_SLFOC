...
PMSM_FOC_PI_t PMSM_FOC_POSITION_PI;	/* Position PI CONTROLLER */
...
void PMSM_FOC_PI_Init(void)
{
  ...
  PMSM_FOC_PLL_PI.error = 0;
	...
	PMSM_FOC_POSITION_PI.kp = PI_CONFIG.PI_POSITION_KP;
	PMSM_FOC_POSITION_PI.ki = PI_CONFIG.PI_POSITION_KI;
	PMSM_FOC_POSITION_PI.scale_kp_ki = PI_CONFIG.PI_POSITION_SCALE;
	
	PMSM_FOC_POSITION_PI.ik_limit_min = PI_CONFIG.PI_POSITION_IK_LIMIT_MIN;
	PMSM_FOC_POSITION_PI.ik_limit_max = PI_CONFIG.PI_POSITION_IK_LIMIT_MAX;
	PMSM_FOC_POSITION_PI.uk_limit_min = PI_CONFIG.PI_POSITION_UK_LIMIT_MIN;
	PMSM_FOC_POSITION_PI.uk_limit_max = PI_CONFIG.PI_POSITION_UK_LIMIT_MAX;
  PMSM_FOC_POSITION_PI.uk_limit_max_scaled = (int32_t)(PMSM_FOC_POSITION_PI.uk_limit_max << PMSM_FOC_POSITION_PI.scale_kp_ki);
  PMSM_FOC_POSITION_PI.uk_limit_min_scaled = (int32_t)(PMSM_FOC_POSITION_PI.uk_limit_min << PMSM_FOC_POSITION_PI.scale_kp_ki);
	
	PMSM_FOC_POSITION_PI.uk = 0;
	PMSM_FOC_POSITION_PI.ik = 0;
	PMSM_FOC_POSITION_PI.error = 0;
