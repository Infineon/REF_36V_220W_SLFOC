      ...
      if (PMSM_FOC_INPUT.user_ctrl_scheme == SPEED_INNER_CURRENT_CTRL_SCHEME)
      {
            ...
            && (PMSM_FOC_CTRL.transition_status == PMSM_FOC_MOTOR_STATUS_TRANSITION))
          {
            ...
            if (PMSM_FOC_PLL_ESTIMATOR.rotor_speed > (2 * MotorParam.ELECTRICAL_SPEED_LOW_LIMIT_TS))
            {
              ...
              PMSM_FOC_POSITION_PI.ik = (int32_t)(PMSM_FOC_OUTPUT.rotor_speed << PMSM_FOC_POSITION_PI.scale_kp_ki);
              PMSM_FOC_SPEED_PI.ik = (int32_t)(PMSM_FOC_OUTPUT.park_transform.torque_iq << PMSM_FOC_SPEED_PI.scale_kp_ki);
              PMSM_FOC_TORQUE_PI.ik = (int32_t)(PMSM_FOC_OUTPUT.torque_vq << PMSM_FOC_TORQUE_PI.scale_kp_ki);
              PMSM_FOC_INPUT.ref_speed= PMSM_FOC_OUTPUT.rotor_speed;
