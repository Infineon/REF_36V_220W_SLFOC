...
void EDL7141_MOTOR_PARAM_set_default(void)
{
  ...
  Edl7141Reg.SUPPLY_CFG = PVCC_10V << SUPPLY_CFG_PVCC_SETPT_Pos |
                          ...
                          BK_FREQ_1M << SUPPLY_CFG_BK_FREQ_Pos |
  ...
  Edl7141Reg.PWM_CFG =    PWM_COMM_MODE_6 << PWM_CFG_PWM_MODE_Pos |
                          ...
                          BRAKE_HIGHZ << PWM_CFG_BRAKE_CFG_Pos |
  ...
  Edl7141Reg.IDRIVE_CFG = IDRIVE_30mA << IDRIVE_CFG_IHS_SRC_Pos |
                          IDRIVE_30mA << IDRIVE_CFG_IHS_SINK_Pos |
                          IDRIVE_30mA << IDRIVE_CFG_ILS_SRC_Pos |
                          IDRIVE_30mA << IDRIVE_CFG_ILS_SINK_Pos;
  Edl7141Reg.IDRIVE_PRE_CFG =   IDRIVE_PRE_40mA << IDRIVE_PRE_CFG_I_PRE_SRC_Pos |
                                IDRIVE_PRE_80mA << IDRIVE_PRE_CFG_I_PRE_SINK_Pos |
                                PRECHAR_MODE_EN << IDRIVE_PRE_CFG_I_PRE_EN_Pos;
  Edl7141Reg.TDRIVE_SRC_CFG =   TDRIVE1_70ns << TDRIVE_SRC_CFG_TDRIVE1_Pos |
                                TDRIVE2_250ns << TDRIVE_SRC_CFG_TDRIVE2_Pos;
  Edl7141Reg.TDRIVE_SINK_CFG =  TDRIVE3_140ns << TDRIVE_SINK_CFG_TDRIVE3_Pos |
                                TDRIVE4_300ns << TDRIVE_SINK_CFG_TDRIVE4_Pos;
  Edl7141Reg.DT_CFG =     DT_600ns << DT_CFG_DT_RISE_Pos |
                          DT_600ns << DT_CFG_DT_FALL_Pos;
  Edl7141Reg.CP_CFG =     CP_CLK_781_25kHz << CP_CFG_CP_CLK_CFG_Pos |
                          CP_CLK_SS_EN << CP_CFG_CP_CLK_SS_DIS_Pos;
  Edl7141Reg.CSAMP_CFG =  CS_GAIN_8V << CSAMP_CFG_CS_GAIN_Pos |
  ...
  /*  CS_GAIN_PROG_ANA  << CSAMP_CFG_CS_GAIN_ANA_Pos |*/
                          CS_DEGLITCH_2us << CSAMP_CFG_CS_OCP_DEGLITCH_Pos |
  ...
  Edl7141Reg.CSAMP_CFG2 = OCP_POS_THR_300mV << CSAMP_CFG2_CS_OCP_PTHR_Pos |
						  ...
						  OCP_FLT_BRAKE_EN << CSAMP_CFG2_CS_OCP_BRAKE_Pos |
