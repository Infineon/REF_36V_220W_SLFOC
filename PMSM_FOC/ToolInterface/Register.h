...
typedef struct
{
    ...
    uint32_t STARTUP_VF_SPEED_RAMP_UP_STEP;
    ...
    uint32_t BEMF_MAX_V;
    uint32_t SPEED_TO_ANGLE_CONV_FACTOR_SCALE;
    uint32_t N_VREF_SVM_V;
    uint32_t SPEED_TO_ANGLE_CONV_RAW;
  uint32_t SPEED_TO_ANGLE_CONV_FACTOR;
  uint32_t SPEED_RAMP_SLEWRATE;
...
typedef struct
{
    ...
    uint32_t PI_POSITION_KP; /*!< USER_PI_POSITION_KP */
    uint32_t PI_POSITION_KI; /*!< USER_PI_POSITION_KI */
    uint32_t PI_POSITION_SCALE; /*!< USER_PI_POSITION_SCALE_KPKI */
    int32_t PI_POSITION_IK_LIMIT_MIN; /*!< USER_PI_POSITION_IK_LIMIT_MIN */
    int32_t PI_POSITION_IK_LIMIT_MAX; /*!< USER_PI_POSITION_IK_LIMIT_MAX */
    int32_t PI_POSITION_UK_LIMIT_MIN; /*!< USER_PI_POSITION_UK_LIMIT_MIN */
    int32_t PI_POSITION_UK_LIMIT_MAX; /*!< USER_PI_POSITION_UK_LIMIT_MAX */
} PI_CONFIG_t;
