...
#pragma diag_suppress=Pa093
  ...
  MotorParam.ROTOR_PRE_ALIGNMENT_RAMP_RATE = (((USER_ROTOR_PRE_ALIGNMENT_V_RAMP_RATE * MotorParam.PWM_PERIOD_TS_US) * 32767.0f / 1000000.0F) / MotorParam.N_VREF_SVM_V);
...
#pragma diag_default=Pe186
  ...
  MotorParam.CONVERT_SPEED_TO_RPM = (uint32_t) ((USER_SPEED_HIGH_LIMIT_RPM * (1 << SPEED_TO_RPM_SCALE)) / MotorParam.ELECTRICAL_SPEED_HIGH_LIMIT_TS);
...
void PI_set_default(void)
{
  ...
  PI_CONFIG.PI_PLL_IK_LIMIT_MIN = USER_PI_PLL_IK_LIMIT_MIN;          /* I[k] output limit LOW. */
  ...
  PI_CONFIG.PI_POSITION_KP = USER_PI_POSITION_KP;
  PI_CONFIG.PI_POSITION_KI = USER_PI_POSITION_KI;
  PI_CONFIG.PI_POSITION_SCALE = USER_PI_POSITION_SCALE_KPKI;
  PI_CONFIG.PI_POSITION_IK_LIMIT_MAX = USER_PI_POSITION_IK_LIMIT_MAX;          /* I[k] output limit HIGH. */
  PI_CONFIG.PI_POSITION_IK_LIMIT_MIN = USER_PI_POSITION_IK_LIMIT_MIN;       /* I[k] output limit LOW. */ 
  PI_CONFIG.PI_POSITION_UK_LIMIT_MAX = (int32_t)(MotorParam.ELECTRICAL_SPEED_HIGH_LIMIT_TS);
  PI_CONFIG.PI_POSITION_UK_LIMIT_MIN = (int32_t)(MotorParam.ELECTRICAL_SPEED_LOW_LIMIT_TS << 1);
