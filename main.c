 ...
 * 
 ********************************************************************************************************************/
volatile uint32_t last_GlobalTimer;
/*********************************************************************************************************************
 * API IMPLEMENTATION
 ********************************************************************************************************************/
/**
...
int main(void)
{
  ...
  while (1)
  {
    ...
    /* Call Demo every 1 ms */
    /* Note that there could be time error depending on the CPU utilizaion. 
       The function/s here should be non-critical */
    if(last_GlobalTimer != SystemVar.GlobalTimer)
    {
      Demo_Func();
      last_GlobalTimer = SystemVar.GlobalTimer;
    }
  }
}
/* End of main () */
